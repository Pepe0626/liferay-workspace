...
<script type="text/javascript" src="http://localhost:8780/konakart_tiles/gensrc/styles/kk-tile-gen.min.csskonakart_tiles/gensrc/script/ddpowerzoomer.js"></script>	
<script type="text/javascript" src="http://localhost:8780/konakart_tiles/gensrc/styles/kk-tile-gen.min.csskonakart_tiles/gensrc/script/jquery.jcarousel.min.js"></script>
<script type="text/javascript" src="http://localhost:8780/konakart_tiles/gensrc/styles/kk-tile-gen.min.csskonakart_tiles/gensrc/script/jquery.touchSwipe.min.js"></script>
<script type="text/javascript" src="http://localhost:8780/konakart_tiles/gensrc/styles/kk-tile-gen.min.csskonakart_tiles/gensrc/script/jquery.konakart.min.js"></script>
