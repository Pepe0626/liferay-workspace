...
{ "javax.portlet.name=" + "com_konakart_liferay_tiles_KKHorizontalCarousel" }, service = ConfigurationAction.class)
public class KKHCarouselPortletInstanceConfigurationAction extends DefaultConfigurationAction
{
     ...
     */
    @Override
    @Reference(target = "(osgi.web.symbolicname=konakart.horizontal.carousel)", unbind = "-")
