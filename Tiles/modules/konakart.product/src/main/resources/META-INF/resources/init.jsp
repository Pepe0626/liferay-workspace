...
<%@ page import="com.konakart.liferay.tiles.KKProductInstanceConfiguration" %>
...
<%
    KKProductInstanceConfiguration configuration = portletDisplay
            .getPortletInstanceConfiguration(KKProductInstanceConfiguration.class);


    String productId = configuration.productId();
    String title = "";
    String addToBasketEnabled = "true";
    String wishListEnabled = "true";
    if (productId.length() > 0)
    {
         title = configuration.title();
         addToBasketEnabled = Boolean.toString(configuration.addToBasketEnabled());
         wishListEnabled = Boolean.toString(configuration.wishListEnabled());
    }   
    ...
    if (log.isDebugEnabled())
    {
        ...
        log.debug("addToBasketEnabled = " + addToBasketEnabled);
        log.debug("wishListEnabled    = " + wishListEnabled);
        log.debug("portletId          = " + portletId);    
    }
%>
<%!
private static Log log = LogFactoryUtil.getLog("com.konakart.product.portlet.init_jsp");
%>
