...
<s:set scope="request" var="setAsPrimaryBool" value="setAsPrimaryBool"/> 
<%boolean setAsPrimaryBool = (Boolean)(request.getAttribute("setAsPrimaryBool")); %>
<s:set scope="request" var="edit" value="edit"/> 
...
<%@include file="AddrValPopup.jsp" %>
				...
				<% } else { %>
					<h1 id="page-title"><kk:msg  key="new.addr.body.title"/></h1>
				<% } %>
				
	    		<div class="content-area rounded-corners">
		    		<div>
						<%if (edit) { %>
							<form action="B2BEditAddressSubmit.action" id="form1" method="post">
						<% } else { %>
							<form action="B2BNewAddressSubmit.action" id="form1" method="post">
						<% } %>
							...
							<% } else { %>
								<input type="hidden" value="<s:property value="setAsPrimaryBool" />" name="setAsPrimaryBool" />
							<% } %>
