 ...
 */
public class B2BEditAddressSubmitAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            kkAppEng.getAdminEng().updateAddress(kkAppEng.getSessionId(), addr);

            // Add a message to say all OK
            addActionMessage(kkAppEng.getMsg("b2beditaddress.book.body.editedok",
