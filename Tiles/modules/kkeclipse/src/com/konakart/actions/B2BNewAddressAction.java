 ...
 */
public class B2BNewAddressAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            if (b2bCustId <= 0)
            {
                String b2bCustIdStr = request.getParameter("custId");
                try
                {
                    b2bCustId = Integer.parseInt(b2bCustIdStr);
                } catch (Exception e)
                {
            ...
            AdminCustomer addrCust = kkAppEng.getAdminEng()
            ...
            // Set the country id
            if (getCountryChange() != 1 && currentCust.getAddresses() != null
                    && currentCust.getAddresses().length > 0)
            {
            ...
            kkAppEng.getNav().add(kkAppEng.getMsg("header.b2baddress.new"), request);
