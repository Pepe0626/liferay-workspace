 ...
 */
public class B2BCustomerRegistrationSubmitAction extends B2BBaseAction
{
    ...
    public String execute()
    {
        ...
        // visible.
        AdminCustomerRegistration cr = new AdminCustomerRegistration();
        ...
        try
        {
            ...
            } else
            {
                ...
                if (getState() != null)
                {
                    // It contains the state name and state id
                    String[] stateArray = getState().split("::");
                    if (stateArray.length == 2)
                    {
                        cr.setState(stateArray[0]);
                    }
                } else
                {
            ...
            kkAppEng.getAdminEng().registerCustomer(kkAppEng.getSessionId(), cr);
            ...
            options.setTemplateName("NewB2BCustomer");
            kkAppEng.getEng().sendNewPassword1(cr.getEmailAddr(), options);
